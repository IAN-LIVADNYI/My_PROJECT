...
describe("CompaniesPage-1: Functionality Testing", () => {
    before(async () => {
    ...
    it("CP-20: Verify user got back to the Companies Page", async () => {
        ...
        // await browser.waitUntil(async () => await (CompaniesPage.elemAnyCompanyCardXpath).isClickable() === true,{timeout:3000});
...
//     })
    ...
    //         await ProblemsPage.inputCompanyName.setValue(`A great company ${new Date().getSeconds()}`)
